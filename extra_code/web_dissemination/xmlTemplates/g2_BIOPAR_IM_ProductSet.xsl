...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gml="http://www.opengis.net/gml">
	...
	<!--version: 0.3, date: 08 october 2009 -->
  <!--todo: factor-out some common routines -->
	<xsl:template match="/">
		<html>
			<head>
				<title>BioPar HR DataSet information</title>
			</head>
			<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
				...
				<h1 style="color:indigo">
					<a name="Top"/>
					  <a href="http://www.gmes.info/pages-principales/projects/land-projects/geoland2/">
				    <img src="http://www.gmes.info/typo3temp/pics/8bafc91001.jpg" width="100" height="89"/>
					</a>
					<big>
						<span>Geoland2 BioPar Product  </span>
					</big>
				...
				<hr/>
					HR Product generated by Infoterra (c) 2009
			</body>
		</html>
	</xsl:template>
  ...
  <xsl:template match="gmd:distributionInfo">
		...
		<blockquote style="margin-top: 0;">
			<table width="800" border="1">
				...
				<tr>
						...
						<td>
							<xsl:for-each select="gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:authority/gmd:CI_Citation">
	...
	<xsl:template name="SpatialDomainTemplate">
        ...
        <xsl:if test="../gmd:referenceSystemInfo">
          <tr>
            <th width="200">Projection / Ellipsoid</th>
        ...
        <xsl:if test="gmd:MD_DataIdentification/gmd:spatialResolution/gmd:MD_Resolution/gmd:distance">
          <tr>
            ...
            <td colspan="2">
			  <xsl:value-of select="gmd:MD_DataIdentification/gmd:spatialResolution/gmd:MD_Resolution/gmd:unit/gco:unit"/>
            </td>
          </tr>
        </xsl:if>
  ...
  <xsl:template name="DistributionTemplate">
    ...
    <xsl:if test="../gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report">
      ...
      <table width="800" border="1">
        ...
        <xsl:for-each select="../gmd:dataQualityInfo/gmd:DQ_DataQuality/gmd:report/gmd:DQ_CompletenessOmission/gmd:result">
          <tr>
