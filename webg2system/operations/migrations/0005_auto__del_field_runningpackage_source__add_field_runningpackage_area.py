...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'RunningPackage.source'
        db.delete_column('operations_runningpackage', 'source_id')

        # Adding field 'RunningPackage.area'
        db.add_column('operations_runningpackage', 'area', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['systemsettings.Area']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'RunningPackage.source'
        raise RuntimeError("Cannot reverse this migration. 'RunningPackage.source' and its values cannot be restored.")

        # Deleting field 'RunningPackage.area'
        db.delete_column('operations_runningpackage', 'area_id')
