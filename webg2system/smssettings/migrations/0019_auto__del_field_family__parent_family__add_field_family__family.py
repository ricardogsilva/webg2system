...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Family._family'
        db.add_column('smssettings_family', '_family', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='smssettings_family_families', null=True, to=orm['smssettings.Family']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Family._parent_family'
        db.add_column('smssettings_family', '_parent_family', self.gf('django.db.models.fields.related.ForeignKey')(related_name='smssettings_family_families', null=True, to=orm['smssettings.Family'], blank=True), keep_default=False)

        # Deleting field 'Family._family'
        db.delete_column('smssettings_family', '_family_id')
