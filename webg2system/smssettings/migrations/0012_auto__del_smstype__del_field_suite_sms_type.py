...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Suite.sms_type'
        db.delete_column('smssettings_suite', 'sms_type_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Suite.sms_type'
        raise RuntimeError("Cannot reverse this migration. 'Suite.sms_type' and its values cannot be restored.")
