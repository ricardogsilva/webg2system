...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Task._family'
        db.alter_column('smssettings_task', '_family_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smssettings.Family'], null=True))
    ...
    models = {
        ...
        'smssettings.task': {
            ...
            '_family': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'smssettings_task_families'", 'null': 'True', 'to': "orm['smssettings.Task']"}),
            '_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            '_path': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '20'})
