...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Family.repeat'
        db.add_column('smssettings_family', 'repeat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smssettings.Repeat'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Family.repeat'
        db.delete_column('smssettings_family', 'repeat_id')
