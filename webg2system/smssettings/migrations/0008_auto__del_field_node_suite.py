...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Node.suite'
        db.delete_column('smssettings_node', 'suite_id')


    def backwards(self, orm):
        
        # Adding field 'Node.suite'
        db.add_column('smssettings_node', 'suite', self.gf('django.db.models.fields.related.ForeignKey')(related_name='my_suite', null=True, to=orm['smssettings.Node'], blank=True), keep_default=False)
