...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Task.family'
        db.delete_column('smssettings_task', 'family_id')


    def backwards(self, orm):
        
        # Adding field 'Task.family'
        db.add_column('smssettings_task', 'family', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['smssettings.Family'], null=True, blank=True), keep_default=False)
