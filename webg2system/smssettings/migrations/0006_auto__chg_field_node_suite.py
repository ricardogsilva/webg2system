...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Node.suite'
        db.alter_column('smssettings_node', 'suite_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['smssettings.Node']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Node.suite'
        raise RuntimeError("Cannot reverse this migration. 'Node.suite' and its values cannot be restored.")
    ...
    models = {
        'smssettings.node': {
            ...
            'suite': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'my_suite'", 'null': 'True', 'to': "orm['smssettings.Node']"})
        },
