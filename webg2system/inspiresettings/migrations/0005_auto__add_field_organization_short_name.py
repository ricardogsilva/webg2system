...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('inspiresettings_organization', 'short_name', self.gf('django.db.models.fields.CharField')(default='IM', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.short_name'
        db.delete_column('inspiresettings_organization', 'short_name')
