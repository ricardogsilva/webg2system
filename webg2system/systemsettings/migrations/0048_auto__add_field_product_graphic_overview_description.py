...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.graphic_overview_description'
        db.add_column('systemsettings_product', 'graphic_overview_description', self.gf('django.db.models.fields.TextField')(default='To be filled out.'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.graphic_overview_description'
        db.delete_column('systemsettings_product', 'graphic_overview_description')
