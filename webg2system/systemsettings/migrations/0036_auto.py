...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('systemsettings_product_keywords', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm['systemsettings.product'], null=False)),
            ('keyword', models.ForeignKey(orm['systemsettings.keyword'], null=False))
        ))
        db.create_unique('systemsettings_product_keywords', ['product_id', 'keyword_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field keywords on 'Product'
        db.delete_table('systemsettings_product_keywords')
