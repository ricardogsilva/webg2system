...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalCodeExtraInfo'
        db.create_table('systemsettings_externalcodeextrainfo', (
            ...
            ('the_package', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.ExternalCode'])),
        ))
        db.send_create_signal('systemsettings', ['ExternalCodeExtraInfo'])

        # Adding model 'ExternalCode'
        db.create_table('systemsettings_externalcode', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('version', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('path', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('version_control_sw', self.gf('django.db.models.fields.CharField')(default='svn', max_length=20)),
            ('code_class', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.CodeClass'])),
        ))
        db.send_create_signal('systemsettings', ['ExternalCode'])

        # Deleting field 'Package.codeClass'
        db.delete_column('systemsettings_package', 'codeClass_id')

        # Adding field 'Package.external_code'
        db.add_column('systemsettings_package', 'external_code',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.ExternalCode'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ExternalCodeExtraInfo'
        db.delete_table('systemsettings_externalcodeextrainfo')

        # Deleting model 'ExternalCode'
        db.delete_table('systemsettings_externalcode')

        # Adding field 'Package.codeClass'
        db.add_column('systemsettings_package', 'codeClass',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['systemsettings.CodeClass']),
                      keep_default=False)

        # Deleting field 'Package.external_code'
        db.delete_column('systemsettings_package', 'external_code_id')
