...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.temporal_extent'
        db.add_column('systemsettings_product', 'temporal_extent', self.gf('django.db.models.fields.TextField')(default='to be filled out.'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.temporal_extent'
        db.delete_column('systemsettings_product', 'temporal_extent')
