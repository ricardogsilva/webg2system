...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.sdi_service_id'
        db.add_column('systemsettings_product', 'sdi_service_id',
                      self.gf('django.db.models.fields.CharField')(default='to be filled out', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.sdi_service_id'
        db.delete_column('systemsettings_product', 'sdi_service_id')
