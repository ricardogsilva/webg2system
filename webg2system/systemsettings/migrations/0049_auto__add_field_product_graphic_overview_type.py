...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.graphic_overview_type'
        db.add_column('systemsettings_product', 'graphic_overview_type', self.gf('django.db.models.fields.CharField')(default='png', max_length=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.graphic_overview_type'
        db.delete_column('systemsettings_product', 'graphic_overview_type')
