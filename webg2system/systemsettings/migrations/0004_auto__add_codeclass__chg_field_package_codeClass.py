...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CodeClass'
        db.create_table('systemsettings_codeclass', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('className', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('systemsettings', ['CodeClass'])

        # Renaming column for 'Package.codeClass' to match new field type.
        db.rename_column('systemsettings_package', 'codeClass', 'codeClass_id')
        # Changing field 'Package.codeClass'
        db.alter_column('systemsettings_package', 'codeClass_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.CodeClass']))

        # Adding index on 'Package', fields ['codeClass']
        db.create_index('systemsettings_package', ['codeClass_id'])


    def backwards(self, orm):
        
        # Removing index on 'Package', fields ['codeClass']
        db.delete_index('systemsettings_package', ['codeClass_id'])

        # Deleting model 'CodeClass'
        db.delete_table('systemsettings_codeclass')

        # Renaming column for 'Package.codeClass' to match new field type.
        db.rename_column('systemsettings_package', 'codeClass_id', 'codeClass')
        # Changing field 'Package.codeClass'
        db.alter_column('systemsettings_package', 'codeClass', self.gf('django.db.models.fields.CharField')(max_length=50))
