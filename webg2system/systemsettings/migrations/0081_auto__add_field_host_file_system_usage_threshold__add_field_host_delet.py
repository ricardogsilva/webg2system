...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.file_system_usage_threshold'
        db.add_column('systemsettings_host', 'file_system_usage_threshold',
                      self.gf('django.db.models.fields.IntegerField')(default=90),
                      keep_default=False)

        # Adding field 'Host.delete_logs'
        db.add_column('systemsettings_host', 'delete_logs',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Host.delete_inputs'
        db.add_column('systemsettings_host', 'delete_inputs',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Host.delete_outputs'
        db.add_column('systemsettings_host', 'delete_outputs',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.file_system_usage_threshold'
        db.delete_column('systemsettings_host', 'file_system_usage_threshold')

        # Deleting field 'Host.delete_logs'
        db.delete_column('systemsettings_host', 'delete_logs')

        # Deleting field 'Host.delete_inputs'
        db.delete_column('systemsettings_host', 'delete_inputs')

        # Deleting field 'Host.delete_outputs'
        db.delete_column('systemsettings_host', 'delete_outputs')
    ...
    models = {
        ...
        'systemsettings.catalogueserver': {
            ...
            'csw_URI': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'systemsettings.externalcode': {
            'Meta': {'object_name': 'ExternalCode'},
            'compilation_environment': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'version': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'version_control_sw': ('django.db.models.fields.CharField', [], {'default': "'svn'", 'max_length': '20'})
        },
        'systemsettings.externalcodeextrainfo': {
            'Meta': {'object_name': 'ExternalCodeExtraInfo', '_ormbases': ['systemsettings.MarkedString']},
            ...
            'the_package': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['systemsettings.ExternalCode']"})
        },
        'systemsettings.file': {
            ...
            'specific_io_buffers': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'systemsettings_file_related'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['systemsettings.Host']"}),
        ...
        'systemsettings.host': {
            ...
            'delete_inputs': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'delete_logs': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'delete_outputs': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'file_system_usage_threshold': ('django.db.models.fields.IntegerField', [], {'default': '90'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.IPAddressField', [], {'max_length': '15'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'password': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'role': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['systemsettings.HostRole']", 'null': 'True', 'blank': 'True'}),
            'username': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'systemsettings.hostrole': {
            'Meta': {'object_name': 'HostRole'},
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        ...
        'systemsettings.package': {
            ...
            'code_class': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['systemsettings.CodeClass']"}),
            'external_code': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['systemsettings.ExternalCode']", 'null': 'True', 'blank': 'True'}),
        ...
        'systemsettings.product': {
            ...
            'parent_id_continental': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'sdi_service_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'series_status': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'series_title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            ...
            'user_manual': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
