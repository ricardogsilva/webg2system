...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.geotiff_dtype'
        db.add_column('systemsettings_product', 'geotiff_dtype',
                      self.gf('django.db.models.fields.CharField')(default='int', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.geotiff_dtype'
        db.delete_column('systemsettings_product', 'geotiff_dtype')
    ...
    models = {
        ...
        'systemsettings.file': {
            ...
            'toDelete': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'systemsettings.product': {
            ...
            'geotiff_dtype': ('django.db.models.fields.CharField', [], {'default': "'int'", 'max_length': '20'}),
