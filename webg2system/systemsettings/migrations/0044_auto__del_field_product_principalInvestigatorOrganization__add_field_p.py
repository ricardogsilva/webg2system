...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.principalInvestigatorOrganization'
        db.delete_column('systemsettings_product', 'principalInvestigatorOrganization_id')

        # Adding field 'Product.principal_investigator'
        db.add_column('systemsettings_product', 'principal_investigator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inspiresettings.Collaborator']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Product.principalInvestigatorOrganization'
        db.add_column('systemsettings_product', 'principalInvestigatorOrganization', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inspiresettings.Collaborator']), keep_default=False)

        # Deleting field 'Product.principal_investigator'
        db.delete_column('systemsettings_product', 'principal_investigator_id')
