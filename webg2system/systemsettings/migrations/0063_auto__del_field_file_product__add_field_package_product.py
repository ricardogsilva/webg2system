...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'File.product'
        db.delete_column('systemsettings_file', 'product_id')

        # Adding field 'Package.product'
        db.add_column('systemsettings_package', 'product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.Product'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'File.product'
        db.add_column('systemsettings_file', 'product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.Product'], null=True, blank=True), keep_default=False)

        # Deleting field 'Package.product'
        db.delete_column('systemsettings_package', 'product_id')
