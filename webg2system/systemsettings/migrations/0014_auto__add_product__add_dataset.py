...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('systemsettings_product', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('systemsettings', ['Product'])

        # Adding model 'Dataset'
        db.create_table('systemsettings_dataset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('unit', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('isMainDataset', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.Product'])),
            ('scalingFactor', self.gf('django.db.models.fields.IntegerField')()),
            ('missingValue', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('systemsettings', ['Dataset'])


    def backwards(self, orm):
        
        # Deleting model 'Product'
        db.delete_table('systemsettings_product')

        # Deleting model 'Dataset'
        db.delete_table('systemsettings_dataset')
