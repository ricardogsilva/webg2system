...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Host.codePath'
        db.add_column('systemsettings_host', 'codePath', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Host.codePath'
        db.delete_column('systemsettings_host', 'codePath')
