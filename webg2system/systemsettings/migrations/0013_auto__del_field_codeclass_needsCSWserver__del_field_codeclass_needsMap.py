...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CodeClass.needsCSWserver'
        db.delete_column('systemsettings_codeclass', 'needsCSWserver')

        # Deleting field 'CodeClass.needsMapserver'
        db.delete_column('systemsettings_codeclass', 'needsMapserver')

        # Deleting field 'Host.hasSMS'
        db.delete_column('systemsettings_host', 'hasSMS')

        # Deleting field 'Host.isArchive'
        db.delete_column('systemsettings_host', 'isArchive')

        # Deleting field 'Host.hasMapserver'
        db.delete_column('systemsettings_host', 'hasMapserver')


    def backwards(self, orm):
        
        # Adding field 'CodeClass.needsCSWserver'
        db.add_column('systemsettings_codeclass', 'needsCSWserver', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'CodeClass.needsMapserver'
        db.add_column('systemsettings_codeclass', 'needsMapserver', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Host.hasSMS'
        db.add_column('systemsettings_host', 'hasSMS', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Host.isArchive'
        db.add_column('systemsettings_host', 'isArchive', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Host.hasMapserver'
        db.add_column('systemsettings_host', 'hasMapserver', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
