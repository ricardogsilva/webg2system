...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Host.delete_files'
        db.add_column('systemsettings_host', 'delete_files',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Host.delete_files'
        db.delete_column('systemsettings_host', 'delete_files')
    ...
    models = {
        ...
        'systemsettings.host': {
            ...
            'delete_files': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
