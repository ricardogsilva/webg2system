...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('systemsettings_webserver', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.Host'])),
            ('public_URL', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('systemsettings', ['WebServer'])

        # Deleting field 'Host.web_server'
        db.delete_column('systemsettings_host', 'web_server')


    def backwards(self, orm):
        
        # Deleting model 'WebServer'
        db.delete_table('systemsettings_webserver')

        # Adding field 'Host.web_server'
        db.add_column('systemsettings_host', 'web_server', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
