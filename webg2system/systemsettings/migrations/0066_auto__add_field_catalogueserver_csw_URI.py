...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CatalogueServer.csw_URI'
        db.add_column('systemsettings_catalogueserver', 'csw_URI', self.gf('django.db.models.fields.CharField')(default='to be specified', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CatalogueServer.csw_URI'
        db.delete_column('systemsettings_catalogueserver', 'csw_URI')
