...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebServer.quicklooks_directory'
        db.add_column('systemsettings_webserver', 'quicklooks_directory',
                      self.gf('django.db.models.fields.CharField')(default='to be defined', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebServer.quicklooks_directory'
        db.delete_column('systemsettings_webserver', 'quicklooks_directory')
    ...
    models = {
        ...
        'systemsettings.webserver': {
            ...
            'quicklooks_directory': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }
