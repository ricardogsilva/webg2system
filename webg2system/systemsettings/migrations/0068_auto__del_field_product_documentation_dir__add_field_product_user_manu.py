...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.documentation_dir'
        db.delete_column('systemsettings_product', 'documentation_dir')

        # Adding field 'Product.user_manual'
        db.add_column('systemsettings_product', 'user_manual', self.gf('django.db.models.fields.CharField')(default='To be filled out.', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Product.documentation_dir'
        db.add_column('systemsettings_product', 'documentation_dir', self.gf('django.db.models.fields.CharField')(default='To be filled out.', max_length=255), keep_default=False)

        # Deleting field 'Product.user_manual'
        db.delete_column('systemsettings_product', 'user_manual')
