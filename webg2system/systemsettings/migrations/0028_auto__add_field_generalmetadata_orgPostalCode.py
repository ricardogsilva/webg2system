...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeneralMetadata.orgPostalCode'
        db.add_column('systemsettings_generalmetadata', 'orgPostalCode', self.gf('django.db.models.fields.CharField')(default='to be filled out', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GeneralMetadata.orgPostalCode'
        db.delete_column('systemsettings_generalmetadata', 'orgPostalCode')
