...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SpecificSource.number'
        db.add_column('systemsettings_specificsource', 'number', self.gf('django.db.models.fields.IntegerField')(default=99), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SpecificSource.number'
        db.delete_column('systemsettings_specificsource', 'number')
