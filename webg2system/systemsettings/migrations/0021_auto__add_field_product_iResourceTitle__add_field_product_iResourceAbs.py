...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.iResourceTitle'
        db.add_column('systemsettings_product', 'iResourceTitle', self.gf('django.db.models.fields.TextField')(default='To be filled out...'), keep_default=False)

        # Adding field 'Product.iResourceAbstract'
        db.add_column('systemsettings_product', 'iResourceAbstract', self.gf('django.db.models.fields.TextField')(default='To be filled out...'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.iResourceTitle'
        db.delete_column('systemsettings_product', 'iResourceTitle')

        # Deleting field 'Product.iResourceAbstract'
        db.delete_column('systemsettings_product', 'iResourceAbstract')
    ...
    models = {
        ...
        'systemsettings.product': {
            ...
            'iResourceTitle': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
