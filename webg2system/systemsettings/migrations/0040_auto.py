...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field topicCategories on 'Product'
        db.create_table('systemsettings_product_topicCategories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm['systemsettings.product'], null=False)),
            ('topiccategory', models.ForeignKey(orm['systemsettings.topiccategory'], null=False))
        ))
        db.create_unique('systemsettings_product_topicCategories', ['product_id', 'topiccategory_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field topicCategories on 'Product'
        db.delete_table('systemsettings_product_topicCategories')
    ...
    models = {
        ...
        'systemsettings.product': {
            ...
            'topicCategories': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['systemsettings.TopicCategory']", 'symmetrical': 'False'})
        },
