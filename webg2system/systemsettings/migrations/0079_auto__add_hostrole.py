...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HostRole'
        db.create_table('systemsettings_hostrole', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('systemsettings', ['HostRole'])

        # Adding M2M table for field role on 'Host'
        db.create_table('systemsettings_host_role', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('host', models.ForeignKey(orm['systemsettings.host'], null=False)),
            ('hostrole', models.ForeignKey(orm['systemsettings.hostrole'], null=False))
        ))
        db.create_unique('systemsettings_host_role', ['host_id', 'hostrole_id'])


    def backwards(self, orm):
        # Deleting model 'HostRole'
        db.delete_table('systemsettings_hostrole')

        # Removing M2M table for field role on 'Host'
        db.delete_table('systemsettings_host_role')
