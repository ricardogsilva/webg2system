...
class Migration(SchemaMigration):
    ...
    models = {
        'systemsettings.archivehost': {
            'Meta': {'object_name': 'ArchiveHost', '_ormbases': ['systemsettings.Host']},
            'host': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['systemsettings.Host']", 'unique': 'True', 'primary_key': 'True'})
        },
        'systemsettings.area': {
