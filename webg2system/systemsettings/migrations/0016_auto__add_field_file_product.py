...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('systemsettings_file', 'product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.Product'], null=True), keep_default=False)
