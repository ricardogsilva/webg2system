...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('systemsettings_controlledvocabulary', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('dateType', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('systemsettings', ['ControlledVocabulary'])

        # Adding model 'Keyword'
        db.create_table('systemsettings_keyword', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('controlledVocabulary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.ControlledVocabulary'], null=True, blank=True)),
        ))
        db.send_create_signal('systemsettings', ['Keyword'])


    def backwards(self, orm):
        
        # Deleting model 'ControlledVocabulary'
        db.delete_table('systemsettings_controlledvocabulary')

        # Deleting model 'Keyword'
        db.delete_table('systemsettings_keyword')
