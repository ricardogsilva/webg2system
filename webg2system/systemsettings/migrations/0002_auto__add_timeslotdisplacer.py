...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('systemsettings_timeslotdisplacer', (
            ...
            ('startValue', self.gf('django.db.models.fields.IntegerField')()),
            ('endValue', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('systemsettings', ['TimeslotDisplacer'])

        # Adding M2M table for field specificTimeslots on 'PackageOutput'
        db.create_table('systemsettings_packageoutput_specificTimeslots', (
        ...
        db.create_unique('systemsettings_packageoutput_specificTimeslots', ['packageoutput_id', 'timeslotdisplacer_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field specificTimeslots on 'PackageOutput'
        db.delete_table('systemsettings_packageoutput_specificTimeslots')
