...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Host.basePath'
        db.delete_column('systemsettings_host', 'basePath')

        # Adding field 'Host.dataPath'
        db.add_column('systemsettings_host', 'dataPath', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Host.basePath'
        db.add_column('systemsettings_host', 'basePath', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'Host.dataPath'
        db.delete_column('systemsettings_host', 'dataPath')
