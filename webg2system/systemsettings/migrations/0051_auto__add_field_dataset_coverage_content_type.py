...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dataset.coverage_content_type'
        db.add_column('systemsettings_dataset', 'coverage_content_type', self.gf('django.db.models.fields.CharField')(default='physicalMeasurement', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dataset.coverage_content_type'
        db.delete_column('systemsettings_dataset', 'coverage_content_type')
