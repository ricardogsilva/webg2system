...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.inspireKeyword'
        db.add_column('systemsettings_product', 'inspireKeyword', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inspiresettings.SpatialDataTheme']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.inspireKeyword'
        db.delete_column('systemsettings_product', 'inspireKeyword_id')
