...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'GeneralMetadata'
        db.delete_table('systemsettings_generalmetadata')


    def backwards(self, orm):
        
        # Adding model 'GeneralMetadata'
        db.create_table('systemsettings_generalmetadata', (
            ('contactEmail', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('orgCity', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('contactName', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('orgStreetAddress', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('orgName', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('orgPostalCode', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('orgURL', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('systemsettings', ['GeneralMetadata'])
