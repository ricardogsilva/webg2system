...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.lineage'
        db.add_column('systemsettings_product', 'lineage', self.gf('django.db.models.fields.TextField')(default='To be filled out'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.lineage'
        db.delete_column('systemsettings_product', 'lineage')
