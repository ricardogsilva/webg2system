...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.series_status'
        db.add_column('systemsettings_product', 'series_status', self.gf('django.db.models.fields.CharField')(default='completed', max_length=20), keep_default=False)

        # Changing field 'Product.series_title'
        db.alter_column('systemsettings_product', 'series_title', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Deleting field 'Product.series_status'
        db.delete_column('systemsettings_product', 'series_status')

        # Changing field 'Product.series_title'
        db.alter_column('systemsettings_product', 'series_title', self.gf('django.db.models.fields.TextField')())
