...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.iResourceType'
        db.delete_column('systemsettings_product', 'iResourceType')

        # Adding field 'Product.resource_type'
        db.add_column('systemsettings_product', 'resource_type', self.gf('django.db.models.fields.CharField')(default='dataset', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Product.iResourceType'
        db.add_column('systemsettings_product', 'iResourceType', self.gf('django.db.models.fields.CharField')(default='dataset', max_length=20), keep_default=False)

        # Deleting field 'Product.resource_type'
        db.delete_column('systemsettings_product', 'resource_type')
    ...
    models = {
        ...
        'systemsettings.product': {
            ...
            'resource_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
