...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ControlledVocabulary.keywords'
        db.delete_column('systemsettings_controlledvocabulary', 'keywords_id')

        # Adding field 'Keyword.controlledVocabulary'
        db.add_column('systemsettings_keyword', 'controlledVocabulary', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.ControlledVocabulary'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ControlledVocabulary.keywords'
        db.add_column('systemsettings_controlledvocabulary', 'keywords', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.Keyword'], null=True, blank=True), keep_default=False)

        # Deleting field 'Keyword.controlledVocabulary'
        db.delete_column('systemsettings_keyword', 'controlledVocabulary_id')
    ...
    models = {
        ...
        'systemsettings.product': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'originatorOrganization': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_systemsettings_product_related'", 'to': "orm['systemsettings.GeneralMetadata']"}),
            'pixelSize': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '4', 'decimal_places': '2'}),
            'principalInvestigatorOrganization': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['systemsettings.GeneralMetadata']"}),
