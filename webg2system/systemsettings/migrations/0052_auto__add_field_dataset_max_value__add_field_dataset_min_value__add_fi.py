...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Dataset.max_value'
        db.add_column('systemsettings_dataset', 'max_value', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Dataset.min_value'
        db.add_column('systemsettings_dataset', 'min_value', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Dataset.bit_depth'
        db.add_column('systemsettings_dataset', 'bit_depth', self.gf('django.db.models.fields.IntegerField')(default=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Dataset.max_value'
        db.delete_column('systemsettings_dataset', 'max_value')

        # Deleting field 'Dataset.min_value'
        db.delete_column('systemsettings_dataset', 'min_value')

        # Deleting field 'Dataset.bit_depth'
        db.delete_column('systemsettings_dataset', 'bit_depth')
