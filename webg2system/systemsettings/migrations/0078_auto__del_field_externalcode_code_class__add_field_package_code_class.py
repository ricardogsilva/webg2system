...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExternalCode.code_class'
        db.delete_column('systemsettings_externalcode', 'code_class_id')

        # Adding field 'Package.code_class'
        db.add_column('systemsettings_package', 'code_class',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['systemsettings.CodeClass']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ExternalCode.code_class'
        db.add_column('systemsettings_externalcode', 'code_class',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['systemsettings.CodeClass']),
                      keep_default=False)

        # Deleting field 'Package.code_class'
        db.delete_column('systemsettings_package', 'code_class_id')
