...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExternalCode.compilation_environment'
        db.add_column('systemsettings_externalcode', 'compilation_environment',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExternalCode.compilation_environment'
        db.delete_column('systemsettings_externalcode', 'compilation_environment')
