...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeneralMetadata.orgStreetAddress'
        db.add_column('systemsettings_generalmetadata', 'orgStreetAddress', self.gf('django.db.models.fields.CharField')(default='To be filled out', max_length=255), keep_default=False)

        # Adding field 'GeneralMetadata.orgCountry'
        db.add_column('systemsettings_generalmetadata', 'orgCountry', self.gf('django.db.models.fields.CharField')(default='PT', max_length=10), keep_default=False)

        # Adding field 'GeneralMetadata.orgCity'
        db.add_column('systemsettings_generalmetadata', 'orgCity', self.gf('django.db.models.fields.CharField')(default='Lisbon', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GeneralMetadata.orgStreetAddress'
        db.delete_column('systemsettings_generalmetadata', 'orgStreetAddress')

        # Deleting field 'GeneralMetadata.orgCountry'
        db.delete_column('systemsettings_generalmetadata', 'orgCountry')

        # Deleting field 'GeneralMetadata.orgCity'
        db.delete_column('systemsettings_generalmetadata', 'orgCity')
    ...
    models = {
        ...
        'systemsettings.generalmetadata': {
            ...
            'orgCountry': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
