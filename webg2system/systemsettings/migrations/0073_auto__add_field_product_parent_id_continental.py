...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.parent_id_continental'
        db.add_column('systemsettings_product', 'parent_id_continental',
                      self.gf('django.db.models.fields.CharField')(default='to be specified', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.parent_id_continental'
        db.delete_column('systemsettings_product', 'parent_id_continental')
