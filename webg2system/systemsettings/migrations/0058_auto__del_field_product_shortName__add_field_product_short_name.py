...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.shortName'
        db.delete_column('systemsettings_product', 'shortName')

        # Adding field 'Product.short_name'
        db.add_column('systemsettings_product', 'short_name', self.gf('django.db.models.fields.CharField')(default='To be filled out', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Product.shortName'
        db.add_column('systemsettings_product', 'shortName', self.gf('django.db.models.fields.CharField')(default='To be filled out', max_length=20), keep_default=False)

        # Deleting field 'Product.short_name'
        db.delete_column('systemsettings_product', 'short_name')
