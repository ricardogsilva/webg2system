...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ControlledVocabulary.description'
        db.delete_column('systemsettings_controlledvocabulary', 'description')

        # Adding field 'Keyword.description'
        db.add_column('systemsettings_keyword', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ControlledVocabulary.description'
        db.add_column('systemsettings_controlledvocabulary', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Keyword.description'
        db.delete_column('systemsettings_keyword', 'description')
