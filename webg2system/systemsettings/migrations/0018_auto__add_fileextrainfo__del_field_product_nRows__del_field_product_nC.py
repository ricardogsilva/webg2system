...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FileExtraInfo'
        db.create_table('systemsettings_fileextrainfo', (
        ...
        db.send_create_signal('systemsettings', ['FileExtraInfo'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FileExtraInfo'
        db.delete_table('systemsettings_fileextrainfo')
