...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.supplemental_info'
        db.add_column('systemsettings_product', 'supplemental_info', self.gf('django.db.models.fields.CharField')(default='to be filled out', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.supplemental_info'
        db.delete_column('systemsettings_product', 'supplemental_info')
