...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'ArchiveHost'
        db.delete_table('systemsettings_archivehost')
        ...
        # Adding field 'File.specificArchives'
        db.add_column('systemsettings_file', 'specificArchives', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.Host'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'ArchiveHost'
        db.create_table('systemsettings_archivehost', (
            ('host', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['systemsettings.Host'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('systemsettings', ['ArchiveHost'])

        # Deleting field 'Host.isArchive'
        db.delete_column('systemsettings_host', 'isArchive')

        # Deleting field 'File.specificArchives'
        db.delete_column('systemsettings_file', 'specificArchives_id')
    ...
    models = {
        ...
        'systemsettings.file': {
            ...
            'specificArchives': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['systemsettings.Host']", 'null': 'True'}),
