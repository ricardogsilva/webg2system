...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field specificArchives on 'File'
        db.create_table('systemsettings_file_specificArchives', (
        ...
        db.create_unique('systemsettings_file_specificArchives', ['file_id', 'host_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field specificArchives on 'File'
        db.delete_table('systemsettings_file_specificArchives')
    ...
    models = {
        ...
        'systemsettings.file': {
            ...
            'specificArchives': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['systemsettings.Host']", 'null': 'True', 'symmetrical': 'False'}),
