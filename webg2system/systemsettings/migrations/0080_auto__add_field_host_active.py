...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field specific_io_buffers on 'File'
        db.create_table('systemsettings_file_specific_io_buffers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('file', models.ForeignKey(orm['systemsettings.file'], null=False)),
            ('host', models.ForeignKey(orm['systemsettings.host'], null=False))
        ))
        db.create_unique('systemsettings_file_specific_io_buffers', ['file_id', 'host_id'])

        # Adding field 'Host.active'
        db.add_column('systemsettings_host', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Removing M2M table for field specific_io_buffers on 'File'
        db.delete_table('systemsettings_file_specific_io_buffers')

        # Deleting field 'Host.active'
        db.delete_column('systemsettings_host', 'active')
