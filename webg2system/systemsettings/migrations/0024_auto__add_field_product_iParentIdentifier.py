...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.iParentIdentifier'
        db.add_column('systemsettings_product', 'iParentIdentifier', self.gf('django.db.models.fields.CharField')(default='to be filled out', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.iParentIdentifier'
        db.delete_column('systemsettings_product', 'iParentIdentifier')
