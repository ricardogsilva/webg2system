...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PackageExtraInfo'
        db.create_table('systemsettings_packageextrainfo', (
        ...
        db.send_create_signal('systemsettings', ['PackageExtraInfo'])


    def backwards(self, orm):
        
        # Deleting model 'PackageExtraInfo'
        db.delete_table('systemsettings_packageextrainfo')
