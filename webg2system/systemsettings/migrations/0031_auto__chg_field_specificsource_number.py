...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpecificSource.number'
        db.alter_column('systemsettings_specificsource', 'number', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'SpecificSource.number'
        db.alter_column('systemsettings_specificsource', 'number', self.gf('django.db.models.fields.IntegerField')(default=99))
