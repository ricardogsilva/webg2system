...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('systemsettings_product', 'originatorOrganization', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='product_systemsettings_product_related', to=orm['systemsettings.GeneralMetadata']), keep_default=False)

        # Adding field 'Product.principalInvestigatorOrganization'
        db.add_column('systemsettings_product', 'principalInvestigatorOrganization', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['systemsettings.GeneralMetadata']), keep_default=False)
