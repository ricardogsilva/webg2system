...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.principalInvestigatorOrganization'
        db.alter_column('systemsettings_product', 'principalInvestigatorOrganization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inspiresettings.Collaborator']))

        # Changing field 'Product.originatorOrganization'
        db.alter_column('systemsettings_product', 'originatorOrganization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inspiresettings.Collaborator']))


    def backwards(self, orm):
        
        # Changing field 'Product.principalInvestigatorOrganization'
        db.alter_column('systemsettings_product', 'principalInvestigatorOrganization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.GeneralMetadata']))

        # Changing field 'Product.originatorOrganization'
        db.alter_column('systemsettings_product', 'originatorOrganization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systemsettings.GeneralMetadata']))
    ...
    models = {
        ...
        'systemsettings.controlledvocabulary': {
            'Meta': {'object_name': 'ControlledVocabulary'},
            'date': ('django.db.models.fields.DateField', [], {}),
            'dateType': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'systemsettings.generalmetadata': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orgCity': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'orgName': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'orgPostalCode': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'orgStreetAddress': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'systemsettings.keyword': {
            ...
            'controlledVocabulary': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['systemsettings.ControlledVocabulary']", 'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        ...
        'systemsettings.product': {
            ...
            'keywords': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['systemsettings.Keyword']", 'symmetrical': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'originatorOrganization': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_systemsettings_product_related'", 'to': "orm['inspiresettings.Collaborator']"}),
            'pixelSize': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '4', 'decimal_places': '2'}),
            'principalInvestigatorOrganization': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['inspiresettings.Collaborator']"}),
            'shortName': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'topicCategories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['systemsettings.TopicCategory']", 'null': 'True', 'blank': 'True'})
        },
