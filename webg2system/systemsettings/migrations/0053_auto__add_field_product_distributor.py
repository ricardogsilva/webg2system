...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.distributor'
        db.add_column('systemsettings_product', 'distributor', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='distributor_systemsettings_product_related', to=orm['inspiresettings.Collaborator']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.distributor'
        db.delete_column('systemsettings_product', 'distributor_id')
