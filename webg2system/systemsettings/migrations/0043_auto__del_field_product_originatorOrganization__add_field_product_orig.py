...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Product.originatorOrganization'
        db.delete_column('systemsettings_product', 'originatorOrganization_id')

        # Adding field 'Product.originator_collaborator'
        db.add_column('systemsettings_product', 'originator_collaborator', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='product_systemsettings_product_related', to=orm['inspiresettings.Collaborator']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Product.originatorOrganization'
        db.add_column('systemsettings_product', 'originatorOrganization', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='product_systemsettings_product_related', to=orm['inspiresettings.Collaborator']), keep_default=False)

        # Deleting field 'Product.originator_collaborator'
        db.delete_column('systemsettings_product', 'originator_collaborator_id')
