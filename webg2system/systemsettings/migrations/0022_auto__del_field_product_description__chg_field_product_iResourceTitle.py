...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('systemsettings_product', 'description')

        # Changing field 'Product.iResourceTitle'
        db.alter_column('systemsettings_product', 'iResourceTitle', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Adding field 'Product.description'
        db.add_column('systemsettings_product', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'Product.iResourceTitle'
        db.alter_column('systemsettings_product', 'iResourceTitle', self.gf('django.db.models.fields.TextField')())
