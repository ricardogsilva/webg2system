...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CatalogueServer'
        db.create_table('systemsettings_catalogueserver', (
        ...
        db.send_create_signal('systemsettings', ['CatalogueServer'])


    def backwards(self, orm):
        
        # Deleting model 'CatalogueServer'
        db.delete_table('systemsettings_catalogueserver')
