...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.validation_report'
        db.add_column('systemsettings_product', 'validation_report', self.gf('django.db.models.fields.CharField')(default='To be filled out', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.validation_report'
        db.delete_column('systemsettings_product', 'validation_report')
