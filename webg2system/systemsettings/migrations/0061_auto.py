...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field sources on 'Product'
        db.create_table('systemsettings_product_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm['systemsettings.product'], null=False)),
            ('source', models.ForeignKey(orm['systemsettings.source'], null=False))
        ))
        db.create_unique('systemsettings_product_sources', ['product_id', 'source_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field sources on 'Product'
        db.delete_table('systemsettings_product_sources')
