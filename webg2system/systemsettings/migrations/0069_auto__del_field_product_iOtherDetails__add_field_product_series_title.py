...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.series_title'
        db.add_column('systemsettings_product', 'series_title', self.gf('django.db.models.fields.TextField')(default='to be filled out'), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Product.series_title'
        db.delete_column('systemsettings_product', 'series_title')
    ...
    models = {
        ...
        'systemsettings.product': {
            ...
            'series_title': ('django.db.models.fields.TextField', [], {}),
