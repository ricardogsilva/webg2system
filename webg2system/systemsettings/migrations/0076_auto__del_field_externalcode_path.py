...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExternalCode.path'
        db.delete_column('systemsettings_externalcode', 'path')


    def backwards(self, orm):
        # Adding field 'ExternalCode.path'
        db.add_column('systemsettings_externalcode', 'path',
                      self.gf('django.db.models.fields.CharField')(default='to be defined', max_length=255),
                      keep_default=False)
